...
Once those are ready, create a github issue following the [review template](https://github.com/SMARTBiomed/software-review/issues/new)

Information about the status of your review and related comments will be associated with that github issue. Make sure your notification settings are such that you will recieve emails when the issue is updated. 


## Instructions for reviewers

You will be tagged and invited to comment on a github issue that contains information about the package to be reviewed. Follow the instructions and leave a comment on the github issue with your review. 
